...
g++ ~/ExpectedForce/parallel/exp_force_openmp.cpp -o ~/ExpectedForce/parallel/output/ExForceOpenmp -std=c++11 -lm

~/ExpectedForce/parallel/output/ExForceOpenmp ~/ExpectedForce/parallel/test_graphs/ready/road-net-ca.txt >> ~/ExpectedForce/parallel/output/stopwatch/road_net_ca_stopwatch_openmp.txt
