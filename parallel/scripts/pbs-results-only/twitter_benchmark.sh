...
~/ExpectedForce/parallel/output/ExForce-Compute ~/ExpectedForce/parallel/test_graphs/ready/twitter.txt 16384 1024 1 1 ~/ExpectedForce/parallel/output/result/twitter.txt >> ~/ExpectedForce/parallel/output/log/twitter.txt