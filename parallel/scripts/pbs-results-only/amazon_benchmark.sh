...
~/ExpectedForce/parallel/output/ExForce-Compute ~/ExpectedForce/parallel/test_graphs/ready/Amazon0302.txt 512 1024 1 1 ~/ExpectedForce/parallel/output/result/amazon.txt >> ~/ExpectedForce/parallel/output/log/amazon.txt
