...
~/ExpectedForce/parallel/output/ExForce-Compute ~/ExpectedForce/parallel/test_graphs/ready/wiki.txt 2048 1024 1 1 ~/ExpectedForce/parallel/output/result/wiki.txt >> ~/ExpectedForce/parallel/output/log/wiki.txt
