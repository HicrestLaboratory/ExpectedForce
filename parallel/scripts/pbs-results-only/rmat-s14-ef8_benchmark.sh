...
~/ExpectedForce/parallel/output/ExForce-Compute ~/ExpectedForce/parallel/test_graphs/ready/rmat_S14_EF8.txt 8192 1024 1 1 ~/ExpectedForce/parallel/output/result/rmat_S14_EF8.txt >> ~/ExpectedForce/parallel/output/log/rmat_S14_EF8.txt
