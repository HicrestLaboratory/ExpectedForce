...
do
    ...
    do
        ~/ExpectedForce/parallel/output/ExForce ~/ExpectedForce/parallel/test_graphs/ready/rmat-14-64.txt $blocks 1024 $stream_count 1 >> ~/ExpectedForce/parallel/output/stopwatch/rmat_S14_EF64_stopwatch.txt
    done 
done
