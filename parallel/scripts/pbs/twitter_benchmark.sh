...
do
    ...
    do
        ~/ExpectedForce/parallel/output/ExForce ~/ExpectedForce/parallel/test_graphs/ready/twitter.txt $blocks 1024 $stream_count 1 >> ~/ExpectedForce/parallel/output/stopwatch/twitter_stopwatch.txt
    done 
done
