...
do
    ...
    do
        ~/ExpectedForce/parallel/output/ExForce ~/ExpectedForce/parallel/test_graphs/ready/rmat_S14_EF16.txt $blocks 1024 $stream_count 1 >> ~/ExpectedForce/parallel/output/stopwatch/rmat_S14_EF16_stopwatch.txt
    done 
done
