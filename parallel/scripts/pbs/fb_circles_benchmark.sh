...
do
    ...
    do
        ~/ExpectedForce/parallel/output/ExForce ~/ExpectedForce/parallel/test_graphs/ready/fb-social-circles.txt $blocks 1024 $stream_count 1 ~/fb_result.txt >> ~/ExpectedForce/parallel/output/fb-social-circles.txt
    done 
done
